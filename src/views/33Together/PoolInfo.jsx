      ...
      <Paper className="psi-card">
        ...
        <Box display="flex" flexDirection="column" className="pool-data">
          ...
          <div className="data-row">
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalDeposits.toLocaleString()} sPSI
            </Typography>
          </div>
          <div className="data-row">
            <Typography>Total Sponsorship</Typography>
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalSponsorship.toLocaleString()} sPSI
            </Typography>
          </div>
          <div className="data-row">
            <Typography>Yield Source</Typography>
            <Typography>sPSI</Typography>
          </div>
          <div className="data-row">
            <Typography>Pool owner</Typography>
            <Box display="flex" alignItems="center">
              <Typography>TridentDAO</Typography>
            </Box>
          </div>
          <Divider color="secondary" />
          <div className="data-row">
        ...
        <div className="data-row-centered">
          <div className="marginedBtn">
            <Button variant="outlined" color="secondary" href={poolTogetherUILinks(chainID)[0]} target="_blank">
              <Typography variant="body1">sPSI Prize Pool&nbsp;</Typography>
              <SvgIcon component={ArrowUp} color="primary" />
            </Button>
          </div>
          <div className="marginedBtn">
            <Button variant="outlined" color="secondary" href={poolTogetherUILinks(chainID)[1]} target="_blank">
              <Typography variant="body1">sPSI Pool Details&nbsp;</Typography>
              <SvgIcon component={ArrowUp} color="primary" />
            </Button>
          </div>
        </div>
